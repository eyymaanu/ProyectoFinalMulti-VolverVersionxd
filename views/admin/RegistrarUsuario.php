    ...
    if (!empty($usuarios)) {
        ...
        foreach ($usuarios as $usuario) {
            ...
            echo '<td class="text-end">
                    ...
                    <form method="POST" action="../proyectofinalmulti/controllers/UPDE/deleteuser.php" style="display:inline;">
            ...
            echo '<form method="POST" action="../proyectofinalmulti/controllers/UPDE/editaruser.php">';
...
document.getElementById('registrationForm').addEventListener('submit', function (e) {
    ...
    fetch('/proyectofinalmulti/controllers/UsuarioControlador.php', {
        method: 'POST',
        body: formData
    })
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            setTimeout(function () {
                    window.location.href = '/proyectofinalmulti/index.php?page=admin/RegistrarUsuario';
                }, 500);
        } else {
