    ...
    if (!empty($autores)) {
        ...
        foreach ($autores as $autor) {
            ...
            echo '<td class="text-end">
                    ...
                    <form method="POST" action="../proyectofinalmulti/controllers/UPDE/delete.php" style="display:inline;">
            ...
            echo '<form method="POST" action="../proyectofinalmulti/controllers/UPDE/editar.php">';
...
document.getElementById('autorform').addEventListener('submit', function (e) {
    ...
    fetch('/proyectofinalmulti/controllers/autorControlador.php', {
        method: 'POST',
        body: formData
    })
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            setTimeout(function () {
                    window.location.href = '/proyectofinalmulti/index.php?page=admin/gestionarAutor';
                }, 500);
        } else {
