<?php
 ...
 require_once($_SERVER['DOCUMENT_ROOT'] . '/ProyectoFinalMulti/models/autorModelo.php');// Incluir el archivo autorModelo.php para poder instanciar el modelo de autores
